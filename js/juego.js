const PALABRAS = [
    ...
    "CABLE", "CAMPO", "CARGO", "CARNE", "CERCA", "CLAVE", "COPIA", "CRUCE",
    "CUIDA", "CUERO", "DEBER", "DOLOR", "DUCHA", "DUEÑO", "DUDAR", "ENTRE",
    "EXITO", "FALSO", "FANGO", "FIRMA", "GENIO", "GENTE", "GIRAR", "GRANO",
    "GRAPA", "GRITO", "GUAPO", "GUISO", "HECHO", "HIELO", "HUEVO", "ISLAS",
    "JARRA", "JUGAR", "JULIO", "JUNIO", "JUNTA", "JURAR", "KOALA", "LARGO",
    "LAPSO", "LIBRO", "LIMBO", "LUNAR", "MARCO", "MANGO", "MATAR", "MORSE",
    "MUCHO", "MUNDO", "NACER", "NIEVE", "NOGAL", "OASIS", "ORDEN", "PIANO",
    "PLAZA", "PRESO", "PUNTA", "PUNTO", "QUESO", "RASCA", "RESTO", "RIGOR",
    "RUEDA", "RUMOR", "SABOR", "SANTO", "SAUNA", "SUEÑO", "TARDE", "TAREA",
    "TESIS", "TOMAR", "UNICO", "UNIDO", "VALOR", "VAPOR", "VERDE", "XENON",
    "YERMO", "ZEBRA", "ZORRA", "ZUMBA", "ZURDO"
];
