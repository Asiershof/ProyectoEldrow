const PALABRAS = [
    "ACERO", "ACTOR", "ANCHO", "APOYO", "ASESO", "ASIER", "AVION", "BALON", 
    "BANCO", "BANDO", "BARCO", "BOLSA", "BOMBA", "BRAVO", "BROMA", "BULTO", 
    "CABLE", "CAMPO", "CARGO", "CARNE", "CEDRO", "CERCA", "CLAVE", "COPIA", 
    "CRUCE", "CUIDA", "CUERO", "DEBER", "DOLOR", "DUCHA", "DUENO", "DUDAR", 
    "EJECA", "EMPLE", "ENFER", "ENTRE", "EXITO", "FALSA", "FANGO", "FIRMA",
    "GENIO", "GENTE", "GIRAR", "GRANO", "GRAPA", "GRITO", "GUAPO", "GUISO", 
    "HECHO", "HIELO", "HUEVO", "ISLAS", "JARRA", "JUGAR", "JUNIO", "JUNTA", 
    "JURAR", "KOALA", "LARGO", "LAPSO", "LIBRO", "LIMBO", "LUNAR", "MARCO", 
    "MANGO", "MATAR", "MORSE", "MUCHA", "MUNDO", "NACER", "NIEVE", "NOGAL", 
    "OASIS", "ORDEN", "PIANO", "PLAZA", "PRESO", "PUNTA", "PUNTO", "QUESO", 
    "RASCA", "RESTO", "RIGOR", "RUEDA", "RUBLO", "RUMOR", "SABOR", "SANTO", 
    "SAUNA", "SUEÑO", "TARDE", "TESIS", "TOMAR", "UNICO", "UNIDO", "VALOR", 
